...
(function(){
  function loadScript(src,cb){
    ...
    s.src=src;s.onload=cb;s.onerror=function(){console.log('CDN failed:'+src);};
  ...
  loadScript('https://www.gstatic.com/firebasejs/10.7.1/firebase-app-compat.js',function(){
    loadScript('https://www.gstatic.com/firebasejs/10.7.1/firebase-database-compat.js',function(){
      try{
        firebase.initializeApp({apiKey:'AIzaSyDYphLCwkifIZnevtopINUCYWgSRkwR1Z4',
          databaseURL:'https://pub-cricket-captain-default-rtdb.firebaseio.com',
          projectId:'pub-cricket-captain',authDomain:'pub-cricket-captain.firebaseapp.com',
          storageBucket:'pub-cricket-captain.firebasestorage.app',
          messagingSenderId:'955219189872',appId:'1:955219189872:web:985212e2eb3e77140fd4b5'});
        var db=firebase.database();
        window._firebaseDB=db;
        window._firebaseSet=function(r,d){return r.set(d);};
        window._firebaseRef_fn=function(db,p){return db.ref(p);};
        window._firebaseOnValue=function(r,cb){return r.on('value',cb);};
        window._firebaseGet=function(r){return r.once('value');};
